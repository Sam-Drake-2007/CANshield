    ...
    <div className="w-screen h-screen relative">
      ...
      {stage !== STAGES.RUNNING && (
        <button
          ...
          className="absolute top-4 right-4 z-[1000] rounded-xl border border-white/10 bg-black/45 backdrop-blur-xl px-3 py-2 text-xs font-semibold text-white/85 hover:bg-white/10"
        >
